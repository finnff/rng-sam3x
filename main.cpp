...
int main() {
  for (;;) {
    ...
    hwlib::cout << "random values between 0 and 100 if no parameters are given: " << hwlib::endl;
    uint_fast32_t y = RandomRange();
    hwlib::cout << y << hwlib::endl;

    hwlib::cout << "random values between given minimum and maximum (666 and 888): " << hwlib::endl;
